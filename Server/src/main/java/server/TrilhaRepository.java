...
public interface TrilhaRepository extends JpaRepository<Trilha, Long>{
	...
	@Query(value = "SELECT * FROM Trilha t WHERE t.maquinaID = :mID AND t.produtoID = :pID AND t.posicao_linha = :linha AND t.posicao_coluna = :coluna AND t.qtde_produtos > 0", nativeQuery = true)
